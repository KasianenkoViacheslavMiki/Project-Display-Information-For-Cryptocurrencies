...
namespace Project_Display_Information_For_Cryptocurrencies.Models
{
    public class Ticker
    {
        ...
        public string? Converted_Last_String { get=>Converted_Last[TargetCurrencies].ToString() + " "+ TargetCurrencies; }
        public string? Converted_Volume_String { get => Converted_Volume[TargetCurrencies].ToString() + " "+ TargetCurrencies; }
